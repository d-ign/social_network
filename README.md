...
<a href="./readme_content/jscpd-report.md">1.05% duplicated lines</a> by <a href="https://github.com/kucherenko/jscpd">jscpd</a>

</div>

## Внимание! В данный момент серверный REST API не оплачен и приложение работает некорректно!
...
- WebSocket (`Chat`)
- SCSS
- Material-UI v.5 (для стилизации форм)
...
&#120824; &#127912; **Смена темы**  по нажатию кнопки на нативном CSS
   ...
   <div align="center"><img src="./readme_content/gif/change_theme.gif" width='60%' /></div>

&#120825; &#9989; **Отзывчивая вёрстка** (от desktop) для всех экранов до 320px с возможностью навигации по приложению **с клавиатуры**
   <div align="center"><img src="./readme_content/gif/adaptive.gif" width='60%' /></div>
...
&#120828; &#11088; **Страница "Профиль"** :
   ...
   <div align="center"><img src="./readme_content/gif/change_status.gif" width='60%' /></div>&#32;&#32;
   ...
   <div align="center"><img src="./readme_content/gif/wall.gif" width='60%' /></div>
...
&#120830; &#128587; **Страница "Поиск пользователей"** :
   ...
   - &#128270; **Поле поиска**:
      ...
      <div align="center"><img src="./readme_content/gif/search_url.gif" width='60%' /></div>
